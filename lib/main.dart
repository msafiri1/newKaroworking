...
import 'package:karostreammemories/config/themes/theme-config.dart';
import 'package:karostreammemories/drive/http/file-entries-api.dart';
import 'package:karostreammemories/drive/screens/destination-picker/destination-picker-state.dart';
import 'package:karostreammemories/drive/screens/file-list/root-screen.dart';
import 'package:karostreammemories/drive/screens/file-preview/file-preview-state.dart';
import 'package:karostreammemories/drive/state/drive-state.dart';
import 'package:karostreammemories/drive/state/entry-cache.dart';
...
import 'package:karostreammemories/drive/state/space-usage/space-usage-state.dart';
import 'package:karostreammemories/localizations/backend-localizations-delegate.dart';
import 'package:karostreammemories/notifications/notifications.dart';
import 'package:karostreammemories/routes.dart';
import 'package:karostreammemories/transfers/downloads/download-manager.dart';
import 'package:karostreammemories/transfers/transfer-queue/transfer-queue.dart';
import 'package:karostreammemories/transfers/uploads/upload-manager.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(context) {
    ...
    return  MaterialApp(
      ...
      theme: buildTheme(context, appConfig.darkThemeConfig!),
